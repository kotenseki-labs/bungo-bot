...
* **Test Locally:** Copy the system prompt from `system_prompt.xml` into your own [Gemini Gem](https://gemini.google.com/gems/view) and test intesively to verify the tutor behaves as expected and doesn't crash.
